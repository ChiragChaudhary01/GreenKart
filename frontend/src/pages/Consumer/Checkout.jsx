...
import { checkoutOrder, viewAddress, viewCart } from '../../api/consumerApi';
            ...
            {cartItem ?
                <div className='px-[10vw] py-5 flex flex-col gap-4'>
                    ...
                    <Formik
                        ...
                        validationSchema={selectedAddress || addresses ? null : orderSchema}   // 🔥 ALWAYS KEEP
                        onSubmit={(values) => {
                            console.log("selectedAddress || values", selectedAddress, values);
